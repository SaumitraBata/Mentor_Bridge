  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-accent/5 to-primary/10 flex items-center justify-center p-6">
      <div className="max-w-md w-full">
        ...
        <div className="bg-card-bg rounded-2xl shadow-lift p-8 border border-border">
          <div className="flex mb-8 bg-background rounded-xl p-1">
            <button
              onClick={() => setIsLogin(true)}
              className={`flex-1 py-3 text-sm font-medium rounded-lg transition-all ${
                isLogin ? 'bg-card-bg text-text-primary shadow-soft' : 'text-text-muted'
              }`}
            >
              Login
            </button>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-4 border border-border rounded-xl focus-ring bg-background"
